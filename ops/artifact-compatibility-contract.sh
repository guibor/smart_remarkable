...
smart_contract_load() {
    ...
    [ "$ARTIFACT_CONTRACT_VERSION" = smart-remarkable-artifacts-v1 ] || return 1
    [ "$SELECTION_PROTOCOL_VERSION" = smart-selection-v2 ] || return 1
    ...
    case "$SCENE_SELECTION_HANDLER_RESOURCE_HASH$SELECTION_CONTEXTUAL_MENU_RESOURCE_HASH" in
        *[!0-9]*) return 1 ;;
    esac
    ...
    for SMART_CONTRACT_VALUE in \
        ...
        "$LEGACY_BUTTON_QMD_SHA256" "$INERT_SOURCE_QMD_SHA256" \
